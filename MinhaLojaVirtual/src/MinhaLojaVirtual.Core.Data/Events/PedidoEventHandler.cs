...
using MinhaLojaVirtual.Core.Messages.CommonMessages.IntegrationEvents;
using MinhaLojaVirtual.Vendas.Application.Commands;

namespace MinhaLojaVirtual.Vendas.Application.Events
{
